/* $Id: atomic.h,v 1.3 2008/09/18 23:34:11 anight Exp $ */
...
static inline int spinlock(atomic_t *lock, int try_once) /* {{{ */
{
	if (try_once) {
		return *lock == 0 && atomic_cmp_set(lock, 0, 1) ? PGG_OK : PGG_ERROR;
	}
